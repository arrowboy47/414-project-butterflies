...
# Likelihood ratio test comparing level-2 and random slope models for light.std
anova(level2.model.light.std, random_slope_model.light.std)

# Plot random slopes for light.avg
ranef(random_slope_model.light.avg)

# Plot random slopes for light.std
ranef(random_slope_model.light.std)
...
plot(plot_gg) + theme_minimal() # You can customize the theme further if needed
